...
import { formatTalentNo } from "@/lib/talents";
import DeleteTalentButton from "@/components/talents/delete-talent-button";
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-start justify-between">
        <div>
          <Link href="/talents" className="text-sm text-gray-500 underline">
            ← タレント一覧に戻る
          </Link>
        ...
        <div className="flex items-center gap-3">
          <Link href={`/talents/${talent.id}/edit`} className="btn-primary">
            編集する
          </Link>
          <DeleteTalentButton talentId={talent.id} name={fullName} />
        </div>
      </div>
