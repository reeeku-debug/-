...
import type { TalentWithRelations } from "@/lib/talents";
import { currentMonthPaymentRecord, formatTalentNo } from "@/lib/talents";
            ...
            return (
              <tr key={t.id} className="align-top hover:bg-brand-50/40">
                ...
                <td className="px-4 py-3 font-semibold">
                  <Link href={`/talents/${t.id}`} className="text-brand-600 hover:underline">
